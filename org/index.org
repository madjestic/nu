...
** DONE : Read the shit above (Emacs calendar), it's awesome!  
* Emacs Calendar: cfw-calendar
  ...
  cfw-calendar https://github.com/kiwanami/emacs-calfw
  # TIPS:
...
** TODO [#E]: Project Omicron:
	 2x1Tb Raid-10?
	 <2015-12-10 Thu>
* Rocket! n-body sim, particles, houdini
  @<->[
...
** IN-PROGRESS [#B]: Write a python daemon
...
*** TODO : Continue converting [[file:~/Documents/Dutch/Vocabulary/total.kvtml][file:~/Documents/Dutch/Vocabulary/total.kvtml]] into Anki
...
** <2016-08-24 Wed> Parsers, Backup, Fixing sink
   @->[[[*<2016-08-25 Thu> Continue with parsing:][<2016-08-25 Thu> Continue with parsing:]]]
   @<-[]
*** DONE : Continue working on Haskell Parser
...
*** DONE : Fill in the holes betwee the tiles near the sink with fugas (in the schoor)
    DEADLINE : <2016-08-24 Wed>
*** IN-PROGRESS [#A] : Backup pictures from MacBookPro to a HDD
*** TODO [#A] : Clone the backup HDD    
...
*** TODO Continue with Parsers:
    DEADLINE: <2016-08-26 Thu>
    @<-[[[*: Continue working on Haskell Parser][: Continue working on Haskell Parser]]
    ]
    @->[[[*Parsing][Parsing]]]
    
    A parser combinator is a higher-order function that takes parsers
    as input and returns a new parser as output. You may remember
    our brief discussion of combinators way back in the lambda calculus
    chapter. Combinators are expressions with no free variables.

    Among other things,
    combinators allow for recursion and for gluing together parsers in a
    modular fashion to parse data according to complex rules.
    
    Since we didn’t use an analogy for Monad
    p923

**** PROGRESS: finished working on reading a file as a ByteString and converting to String ([Char])
...
main = do
  text <- getJson
  putStrLn $ BC.unpack text -- here file gets read as a bytesting and byte8
                            -- representation is converted into [Char]
    
**** PROGRESS: finished a basic setup:
**** TODO : continue with parser combinators, parsing the geo file
     DEADELINE: <2016-08-30 Tue>
     [[file:~/Projects/Haskell/Parser/Haskell_Parsec_Basics/haskell-parsec-basics/Main.hs][file:~/Projects/Haskell/Parser/Haskell_Parsec_Basics/haskell-parsec-basics/Main.hs]]

**** Study material:
    [[/home/madjestic/Documents/haskell-programming-0.11.2-screen.pdf]]
    http://unbui.lt/#!/post/haskell-parsec-basics
    [[file:~/Downloads/examples.hs][file:~/Downloads/examples.hs]]

**** Work material:
    [[file:~/Projects/Haskell/Parser/Haskell_Parsec_Basics/haskell-parsec-basics/Main.hs]]
    [[file:~/Projects/Haskell/Parser/Haskell_Parsec_Basics/haskell-parsec-basics/ByteSring.hs][file:~/Projects/Haskell/Parser/Haskell_Parsec_Basics/haskell-parsec-basics/ByteSring.hs]]

    [[file:~/Projects/Haskell/Parser/Trifecta/LearnParsers.hs]]
    [[file:~/Projects/Houdini/Parser/Parser/export/model.geo][file:~/Projects/Houdini/Parser/Parser/export/model.geo]] - Houdini cube geometry
    [[/home/madjestic/Projects/Haskell/Parser/Parsec/Pizza.hs]]
